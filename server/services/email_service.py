...
def send_booking_confirmation_email(booking):
    ...
    try:
            ...
            <div class="container">
                ...
                <div class="content">
                    ...
                    <div style="text-align: center; margin: 30px 0;">
                        ...
                        <a href="{booking.meeting_link}" class="meeting-link">Join Google Meet</a>
                        <p style="font-size: 12px; color: #6b7280;">Or copy this link: {booking.meeting_link}</p>
                    </div>
        ...
        {f'Join your video inspection meeting: {booking.meeting_link}' if booking.meeting_link else ''}
